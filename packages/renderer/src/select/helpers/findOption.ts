...
export const findFirstOption = (container: HTMLElement | null): Element | null => {
  return container?.querySelector('[role=option]') ?? null;
};

export const findLastOption = (container: HTMLElement | null): Element | null => {
